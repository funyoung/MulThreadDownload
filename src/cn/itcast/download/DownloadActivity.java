...
public class DownloadActivity extends Activity {
	private static final String testUrl = "http://taogu91-test.oss-cn-qingdao.aliyuncs.com/download/xinxiangzhongxinyiyuan.89.apk";
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		downloadpathText.append(testUrl);
